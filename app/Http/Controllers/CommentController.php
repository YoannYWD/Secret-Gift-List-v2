...
class CommentController extends Controller
{
    ...
    public function create(Request $request) {
        ...
        $gift = DB::table('gifts')
                    ...
                    ->select('gifts.id', 'gifts.name', 'gifts.price', 'gifts.description', 'gifts.image', 'gifts.posted_by_user_id', 'gifts.for_user_id as for_user_id', 'users.nickname as user_nickname', 'users.image as user_image')
